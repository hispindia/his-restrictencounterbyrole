	...
	<c:if test="${numberOfPages > 0 }">
		<ul class="pageSizeSelection">
			<li><span><spring:message code="inventory.paging.totalpage"/>:</span> ${numberOfPages}</li>
		  	<li><span><spring:message code="inventory.paging.pagesize"/>:</span>
			 <input type="text" id="sizeOfPage" value="${pageSize}" style="width:50px" onchange="changePageSize('${baseLink}');"></li>
			<li> <span ><spring:message code="inventory.paging.jumptopage"/>:</span>
